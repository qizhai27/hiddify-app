...
const Map<String, OrgIconData> organizationData = {
  ...
  "azure": OrgIconData(IconData(0xf17a, fontFamily: 'FontAwesomeBrands', fontPackage: 'font_awesome_flutter'), Color(0xFF0078D4)),
  "amazon": OrgIconData(IconData(0xf375, fontFamily: 'FontAwesomeBrands', fontPackage: 'font_awesome_flutter'), Color(0xFFFF9900)),
  "oracle": OrgIconData(IconData(0xf1c0, fontFamily: 'FontAwesomeSolid', fontPackage: 'font_awesome_flutter'), Color(0xFFF80000)),
